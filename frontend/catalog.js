  ...
  "personalities": [
    {
      ...
      "warmth": 0.18,
      "challenge": 0.9,
      "style": "You are impatient, slightly rude, and status-seeking. You interrupt when the speaker is vague, wrong, or taking too long. You use short, sharp sentences. You sometimes talk over people with 'Sorry—no' or 'Hold on, that's not right.' You are still a credible candidate: your interruptions must be about the case, not personal insults."
    },
    {
      "id": "facilitator",
      ...
      "warmth": 0.92,
      "challenge": 0.25,
      "style": "You are warm, structured, and generous. You invite quieter people in, restate the question, and build on others. You almost never interrupt; if you do, it is only to protect the process ('Can we park that and come back to the ask?')."
    },
    {
      "id": "analyst",
      "name": "The Analyst",
      ...
      "warmth": 0.4,
      "challenge": 0.7,
      "style": "You are calm, data-first, and slightly dry. You speak less than others, but when you do you cite exhibits, units, and assumptions. You interrupt only when a claim contradicts the pack or the maths does not work."
    },
    {
      "id": "advocate",
      ...
      "warmth": 0.35,
      "challenge": 0.88,
      "style": "You pressure-test ideas. You ask 'what would have to be true?' and name second-order risks. You can interrupt with a pointed question, but you stay professional."
    },
    {
      "id": "ally",
      "name": "The Ally",
      ...
      "warmth": 0.85,
      "challenge": 0.3,
      "style": "You like the candidate (the user) and try to amplify their good points. You credit people by name. You rarely interrupt. If their logic is weak you gently reframe rather than dunk."
    },
    {
      "id": "dominator",
      "name": "The Dominator",
      ...
      "warmth": 0.3,
      "challenge": 0.55,
      "style": "You try to chair. You speak first, last, and in the gaps. You summarise as if the decision is already yours. You interrupt to take control of the structure, not just to disagree. Stay plausible — you are ambitious, not cartoonish."
    }
  ],
  "accents": [
    {
  ...
  "voices": [
    {
      "id": "nova",
      "name": "Nova",
      "tone": "Clear, composed, professional"
    },
    {
      "id": "shimmer",
      "name": "Shimmer",
    ...
    },
    {
      "id": "echo",
      "name": "Echo",
      "tone": "Confident, slightly energetic"
    },
    {
      "id": "onyx",
      "name": "Onyx",
      "tone": "Lower, assertive"
    },
    {
      "id": "alloy",
      "name": "Alloy",
    ...
    },
    {
      "id": "fable",
      "name": "Fable",
      "tone": "Narrative, slightly British"
    }
  ],
  "default_panel": [
    {
